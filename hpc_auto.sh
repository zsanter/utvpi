...
#
# This script is meant specifically for running auto.sh on a high-performance computing system running PBS/Torque.

# Specify job name
#PBS -N utvpi_profile

# Specify the resources needed for the job
# 1 node, 1 processor per node, 54 GB of memory, 24 hours max
