/*
 * lahiriFIFO.c
 * The Lahiri-Musuvathi integral UTVPI system solver, with FIFO linear modification
...
/*
 * backtrack() implements a single backtrack through the predecessor structure, as defined in Network Flows. This function should
 * only be called in the situation that it is guaranteed that the function will detect a negative cost cycle. Returns a pointer to
 * an Edge within the detected negative cost cycle. 
 * 
